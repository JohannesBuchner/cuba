...
:Evaluate: System`MinPoints::usage = "MinPoints is an option of Suave.
...
:Begin:
:Function: Suave
:Pattern: MLSuave[ndim_, ncomp_, epsrel_, epsabs_, flags_, mineval_, maxeval_, nnew_, flatness_]
:Arguments: {ndim, ncomp, epsrel, epsabs, flags, mineval, maxeval, nnew, flatness}
:ArgumentTypes: {Integer, Integer, Real, Real, Integer, Integer, Integer, Integer, Real}
:ReturnType: Manual
:End:
...
static void DoSample(cnumber n, real *x, real *f)
{
  ...
  MLPutFunction(stdlink, "EvaluatePacket", 1);
  MLPutFunction(stdlink, "Suave`Private`sample", 1);
